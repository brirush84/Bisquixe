...
function do_gestalt(val,val2){var ix;switch(val){case 0:return 0x00030103;case 1:return 0x00020201;case 2:return 1;case 3:return 1;case 4:switch(val2){case 0:return 1;case 1:return 1;case 2:return 1;default:return 0;}
...
5382:new FuncSpec(5381,"add_image",new Prototype([arg_int_signed, new ArgString(), new ArgString(), arg_int_signed, arg_int_signed],null))

};self.arg_int_unsigned=arg_int_unsigned;self.arg_int_signed=arg_int_signed;self.arg_char_unsigned=arg_char_unsigned;self.arg_char_native=arg_char_native;self.arg_char_signed=arg_char_signed;function convert_arg(arg,passin,val){if(arg instanceof ArgInt){if(passin){if(!arg.signed)
return val;else
